	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float localMudBunMeshPoint4_g249 = ( 0.0 );
				int VertexID4_g249 = inputMesh.ase_vertexID;
				float3 PositionWs4_g249 = float3( 0,0,0 );
				float3 PositionLs4_g249 = float3( 0,0,0 );
				float3 NormalWs4_g249 = float3( 0,0,0 );
				float3 NormalLs4_g249 = float3( 0,0,0 );
				float3 TangentWs4_g249 = float3( 0,0,0 );
				float3 TangentLs4_g249 = float3( 0,0,0 );
				float4 Color4_g249 = float4( 0,0,0,0 );
				float4 EmissionHash4_g249 = float4( 0,0,0,0 );
				float Metallic4_g249 = 0;
				float Smoothness4_g249 = 0;
				float4 TextureWeight4_g249 = float4( 1,0,0,0 );
				float SdfValue4_g249 = 0;
				float3 Outward2dNormalLs4_g249 = float3( 0,0,0 );
				float3 Outward2dNormalWs4_g249 = float3( 0,0,0 );
				{
				float4 positionWs;
				float2 metallicSmoothness;
				mudbun_mesh_vert(VertexID4_g249, positionWs, PositionLs4_g249, NormalWs4_g249, NormalLs4_g249, TangentWs4_g249, TangentLs4_g249, Color4_g249, EmissionHash4_g249, metallicSmoothness, TextureWeight4_g249, SdfValue4_g249, Outward2dNormalLs4_g249, Outward2dNormalWs4_g249);
				PositionWs4_g249 = positionWs.xyz;
				Metallic4_g249 = metallicSmoothness.x;
				Smoothness4_g249 = metallicSmoothness.y;
				#ifdef MUDBUN_BUILT_IN_RP
				#ifndef MUDBUN_VERTEX_SHADER
				v.tangent = float4(TangentWs4_g249, 0.0f);
				#define MUDBUN_VERTEX_SHADER
				#endif
				#endif
				}
				float3 temp_output_254_0 = PositionWs4_g249;
				...
				float3 vertexToFrag16_g249 = PositionWs4_g249;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag16_g249;
				float3 vertexToFrag27_g253 = temp_output_254_0;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag27_g253;
				...
				inputMesh.tangentOS = float4( TangentWs4_g249 , 0.0 );
						...
						)
			{
				...
				float3 temp_output_44_0_g251 = ( appendResult221 * abs( vertexToFrag213 ) );
				float3 break14_g251 = temp_output_44_0_g251;
				float3 vertexToFrag212 = packedInput.ase_texcoord6.xyz;
				float3 temp_output_36_0_g251 = vertexToFrag212;
				float4 appendResult23_g251 = (float4(temp_output_44_0_g251 , 0.0));
				float4 appendResult24_g251 = (float4(temp_output_44_0_g251 , 1.0));
				float4 break10_g252 = ( ( break14_g251.x + break14_g251.y + break14_g251.z ) > 0.0 ? appendResult23_g251 : appendResult24_g251 );
				float4 color20_g251 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 color227 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 vertexToFrag5_g249 = packedInput.ase_texcoord7;
				float4 temp_output_25_0_g249 = ( _IsMeshRenderMaterial * _Color * vertexToFrag5_g249 );
				float4 temp_output_175_0 = ( ( _UseTex0 > 0.0 ? ( ( ( ( break14_g251.x > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g251).yz * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g252.x ) + ( ( break14_g251.y > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g251).zx * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g252.y ) + ( ( break14_g251.z > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g251).xy * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g252.z ) + ( color20_g251 * break10_g252.w ) ) / ( break10_g252.x + break10_g252.y + break10_g252.z + break10_g252.w ) ) : color227 ) * temp_output_25_0_g249 );
				float localComputeOpaqueTransparency20_g253 = ( 0.0 );
				float3 vertexToFrag16_g249 = packedInput.ase_texcoord8.xyz;
				float4 unityObjectToClipPos1_g250 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g249));
				float4 computeScreenPos3_g250 = ComputeScreenPos( unityObjectToClipPos1_g250 , _ProjectionParams.x );
				float2 ScreenPos20_g253 = (( ( computeScreenPos3_g250 / (computeScreenPos3_g250).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g253 = packedInput.ase_texcoord9.xyz;
				float3 VertPos20_g253 = vertexToFrag27_g253;
				float localMudBunMeshPoint4_g249 = ( 0.0 );
				...
				float Hash20_g253 = (EmissionHash4_g249).w;
				float AlphaIn20_g253 = (temp_output_25_0_g249).a;
				float AlphaOut20_g253 = 0;
				float AlphaThreshold20_g253 = 0;
				sampler2D DitherNoiseTexture20_g253 = _DitherTexture;
				int DitherNoiseTextureSize20_g253 = _DitherTextureSize;
				int UseRandomDither20_g253 = (int)_RandomDither;
				float AlphaCutoutThreshold20_g253 = _AlphaCutoutThreshold;
				float DitherBlend20_g253 = _Dithering;
				{
				float alpha = AlphaIn20_g253;
				computeOpaqueTransparency(ScreenPos20_g253, VertPos20_g253, Hash20_g253, DitherNoiseTexture20_g253, DitherNoiseTextureSize20_g253, UseRandomDither20_g253 > 0, AlphaCutoutThreshold20_g253, DitherBlend20_g253,  alpha, AlphaThreshold20_g253);
				AlphaOut20_g253 = alpha;
				}
				float temp_output_247_0 = ( (temp_output_175_0).w * AlphaOut20_g253 );
				float temp_output_255_25 = AlphaThreshold20_g253;
				clip( temp_output_247_0 - temp_output_255_25);
				
				float3 appendResult260 = (float3(_MainNormX , _MainNormY , _MainNormZ));
				float3 temp_output_44_0_g254 = ( appendResult260 * abs( vertexToFrag213 ) );
				float3 break14_g254 = temp_output_44_0_g254;
				float3 temp_output_36_0_g254 = vertexToFrag212;
				float4 appendResult23_g254 = (float4(temp_output_44_0_g254 , 0.0));
				float4 appendResult24_g254 = (float4(temp_output_44_0_g254 , 1.0));
				float4 break10_g255 = ( ( break14_g254.x + break14_g254.y + break14_g254.z ) > 0.0 ? appendResult23_g254 : appendResult24_g254 );
				float4 color20_g254 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				...
				surfaceDescription.Normal = UnpackNormalScale( ( _UseNorm0 > 0.0 ? ( ( ( ( break14_g254.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g254).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g255.x ) + ( ( break14_g254.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g254).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g255.y ) + ( ( break14_g254.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g254).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g255.z ) + ( color20_g254 * break10_g255.w ) ) / ( break10_g255.x + break10_g255.y + break10_g255.z + break10_g255.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag27_g253 = temp_output_254_0;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag27_g253;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 computeScreenPos3_g250 = ComputeScreenPos( unityObjectToClipPos1_g250 , _ProjectionParams.x );
				float2 ScreenPos20_g253 = (( ( computeScreenPos3_g250 / (computeScreenPos3_g250).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g253 = packedInput.ase_texcoord4.xyz;
				float3 VertPos20_g253 = vertexToFrag27_g253;
				float localMudBunMeshPoint4_g249 = ( 0.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g253 = temp_output_254_0;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag27_g253;
					...
					)
			{
				...
				float4 computeScreenPos3_g250 = ComputeScreenPos( unityObjectToClipPos1_g250 , _ProjectionParams.x );
				float2 ScreenPos20_g253 = (( ( computeScreenPos3_g250 / (computeScreenPos3_g250).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g253 = packedInput.ase_texcoord5.xyz;
				float3 VertPos20_g253 = vertexToFrag27_g253;
				float localMudBunMeshPoint4_g249 = ( 0.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g253 = temp_output_254_0;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag27_g253;
					...
					)
			{
				...
				float4 computeScreenPos3_g250 = ComputeScreenPos( unityObjectToClipPos1_g250 , _ProjectionParams.x );
				float2 ScreenPos20_g253 = (( ( computeScreenPos3_g250 / (computeScreenPos3_g250).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g253 = packedInput.ase_texcoord7.xyz;
				float3 VertPos20_g253 = vertexToFrag27_g253;
				float localMudBunMeshPoint4_g249 = ( 0.0 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag27_g253 = temp_output_254_0;
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag27_g253;
						...
						)
			{
				...
				float4 computeScreenPos3_g250 = ComputeScreenPos( unityObjectToClipPos1_g250 , _ProjectionParams.x );
				float2 ScreenPos20_g253 = (( ( computeScreenPos3_g250 / (computeScreenPos3_g250).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g253 = packedInput.ase_texcoord11.xyz;
				float3 VertPos20_g253 = vertexToFrag27_g253;
				float localMudBunMeshPoint4_g249 = ( 0.0 );
...
/*ASEBEGIN
Version=18935
396;313.6;1104;664.6;1196.78;1338.566;2.403246;True;False
Node;AmplifyShaderEditor.FunctionNode;254;-128,-192;Inherit;False;Mud Mesh;0;;249;4f444db5091a94140ab2b15b933d37b6;0;0;17;COLOR;9;FLOAT;13;FLOAT3;10;FLOAT;11;FLOAT;12;FLOAT4;33;FLOAT3;0;FLOAT3;32;FLOAT3;2;FLOAT3;31;FLOAT3;53;FLOAT3;52;FLOAT3;48;FLOAT3;46;FLOAT;45;FLOAT2;15;FLOAT;41
Node;AmplifyShaderEditor.RangedFloatNode;217;256,-448;Inherit;False;Property;_MainTexZ;Project Texture 0 Z;17;1;[Toggle];Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;256,-528;Inherit;False;Property;_MainTexY;Project Texture 0 Y;16;1;[Toggle];Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;219;256,-608;Inherit;False;Property;_MainTexX;Project Texture 0 X;13;1;[Toggle];Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;222;256,-816;Inherit;True;Property;_MainTex;Albedo;10;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.VertexToFragmentNode;213;384,-176;Inherit;False;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DynamicAppendNode;221;576,-592;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.VertexToFragmentNode;212;384,-256;Inherit;False;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;227;896,-592;Inherit;False;Constant;_Color2;Color 2;26;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;229;256,-896;Inherit;False;Property;_UseTex0;Use Texture;9;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;228;896,-816;Inherit;False;Mud Triplanar Sample;-1;;251;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;259;256,-1184;Inherit;False;Property;_MainNormX;Project Normal Map 0 X;18;1;[Toggle];Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;257;256,-1104;Inherit;False;Property;_MainNormY;Project Normal Map 0 Y;19;1;[Toggle];Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;258;256,-1024;Inherit;False;Property;_MainNormZ;Project Normal Map 0 Z;20;1;[Toggle];Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;230;1264,-896;Inherit;False;2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT4;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;232;-128,576;Inherit;False;Property;_RandomDither;Random Dither;8;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;241;-128,480;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;15;0;Create;True;0;0;0;False;0;False;256;256;False;0;1;INT;0
Node;AmplifyShaderEditor.DynamicAppendNode;260;576,-1168;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode;240;-128,256;Inherit;True;Property;_DitherTexture;Dither Texture;12;0;Create;True;0;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;264;256,-1408;Inherit;True;Property;_MainNorm;Normal Map 0;14;0;Create;False;0;0;0;False;0;False;None;None;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;255;1024,128;Inherit;False;Mud Alpha Threshold;-1;;253;926535703f4c32948ac1f55275a22bf0;0;9;8;FLOAT2;0,0;False;15;FLOAT3;0,0,0;False;18;FLOAT;0;False;22;FLOAT;0;False;19;SAMPLER2D;0;False;26;INT;256;False;9;INT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;2;FLOAT;24;FLOAT;25
Node;AmplifyShaderEditor.FunctionNode;261;896,-1184;Inherit;False;Mud Triplanar Sample;-1;;254;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;262;1280,-1408;Inherit;False;Property;_UseNorm0;Use Normal Map;11;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;256;1280,-1152;Inherit;False;Constant;_Flat;Flat;26;0;Create;True;0;0;0;False;0;False;0.5019608,0.5019608,1,1;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Compare;263;1536,-1408;Inherit;False;2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT4;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.UnpackScaleNormalNode;265;1728,-1408;Inherit;False;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;228;36;212;0
WireConnection;228;37;213;0
WireConnection;228;3;222;0
WireConnection;228;26;222;1
WireConnection;228;11;221;0
...
WireConnection;261;36;212;0
WireConnection;261;37;213;0
WireConnection;261;3;264;0
WireConnection;261;26;264;1
WireConnection;261;11;260;0
WireConnection;176;0;175;0
WireConnection;263;0;262;0
WireConnection;263;2;261;0
WireConnection;263;3;256;0
...
WireConnection;86;27;254;53
ASEEND*/
//CHKSM=D156BBBF7FB38F69B48932FC1A2A7BDF049163F4