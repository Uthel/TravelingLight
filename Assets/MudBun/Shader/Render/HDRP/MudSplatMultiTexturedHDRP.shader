	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g36 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag27_g36;
						...
						)
			{
				...
				float2 temp_output_23_0_g34 = clampResult36_g32;
				...
				float3 Outward2dNormalWs5_g32 = float3( 0,0,0 );
				float3 localMudBunSplatPoint5_g32 = MudBunSplatPoint( VertexID5_g32 , PositionLs5_g32 , NormalWs5_g32 , NormalLs5_g32 , TangentWs5_g32 , TangentLs5_g32 , CenterWs5_g32 , CenterLs5_g32 , Color5_g32 , EmissionHash5_g32 , Metallic5_g32 , Smoothness5_g32 , Tex5_g32 , TextureWeight5_g32 , SdfValue5_g32 , Outward2dNormalLs5_g32 , Outward2dNormalWs5_g32 );
				float4 break10_g35 = TextureWeight5_g32;
				float4 vertexToFrag3_g32 = packedInput.ase_texcoord6;
				float4 temp_output_7_0_g32 = ( _Color * vertexToFrag3_g32 * _IsSplatRenderMaterial );
				float4 temp_output_124_0 = ( ( ( ( ( (float)1 > 0.0 ? tex2D( _MainTex, temp_output_23_0_g34 ) : float4( 0,0,0,0 ) ) * break10_g35.x ) + ( ( (float)(int)_UseTex1 > 0.0 ? tex2D( _Tex1, temp_output_23_0_g34 ) : float4( 0,0,0,0 ) ) * break10_g35.y ) + ( ( (float)(int)_UseTex2 > 0.0 ? tex2D( _Tex2, temp_output_23_0_g34 ) : float4( 0,0,0,0 ) ) * break10_g35.z ) + ( ( (float)(int)_UseTex3 > 0.0 ? tex2D( _Tex3, temp_output_23_0_g34 ) : float4( 0,0,0,0 ) ) * break10_g35.w ) ) / ( break10_g35.x + break10_g35.y + break10_g35.z + break10_g35.w ) ) * temp_output_7_0_g32 );
				float localComputeOpaqueTransparency20_g36 = ( 0.0 );
				float3 vertexToFrag20_g32 = packedInput.ase_texcoord7.xyz;
				float4 unityObjectToClipPos1_g33 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g32));
				float4 computeScreenPos3_g33 = ComputeScreenPos( unityObjectToClipPos1_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g36 = (( ( computeScreenPos3_g33 / (computeScreenPos3_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g36 = packedInput.ase_texcoord8.xyz;
				float3 VertPos20_g36 = vertexToFrag27_g36;
				float Hash20_g36 = (EmissionHash5_g32).w;
				...
				#endif
				float AlphaIn20_g36 = ( (temp_output_7_0_g32).a * staticSwitch50_g32 );
				float AlphaOut20_g36 = 0;
				float AlphaThreshold20_g36 = 0;
				sampler2D DitherNoiseTexture20_g36 = _DitherTexture;
				int DitherNoiseTextureSize20_g36 = _DitherTextureSize;
				int UseRandomDither20_g36 = (int)_RandomDither;
				float AlphaCutoutThreshold20_g36 = _AlphaCutoutThreshold;
				float DitherBlend20_g36 = _Dithering;
				{
				float alpha = AlphaIn20_g36;
				computeOpaqueTransparency(ScreenPos20_g36, VertPos20_g36, Hash20_g36, DitherNoiseTexture20_g36, DitherNoiseTextureSize20_g36, UseRandomDither20_g36 > 0, AlphaCutoutThreshold20_g36, DitherBlend20_g36,  alpha, AlphaThreshold20_g36);
				AlphaOut20_g36 = alpha;
				}
				float temp_output_194_0 = ( (temp_output_124_0).w * AlphaOut20_g36 );
				float temp_output_119_25 = AlphaThreshold20_g36;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag27_g36 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag27_g36;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 computeScreenPos3_g33 = ComputeScreenPos( unityObjectToClipPos1_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g36 = (( ( computeScreenPos3_g33 / (computeScreenPos3_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g36 = packedInput.ase_texcoord3.xyz;
				float3 VertPos20_g36 = vertexToFrag27_g36;
				float Hash20_g36 = (EmissionHash5_g32).w;
				float ifLocalVar62_g32 = 0;
				UNITY_BRANCH 
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g36 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag27_g36;
					...
					)
			{
				...
				float4 computeScreenPos3_g33 = ComputeScreenPos( unityObjectToClipPos1_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g36 = (( ( computeScreenPos3_g33 / (computeScreenPos3_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g36 = packedInput.ase_texcoord4.xyz;
				float3 VertPos20_g36 = vertexToFrag27_g36;
				float Hash20_g36 = (EmissionHash5_g32).w;
				float ifLocalVar62_g32 = 0;
				UNITY_BRANCH 
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g36 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag27_g36;
					...
					)
			{
				...
				float4 computeScreenPos3_g33 = ComputeScreenPos( unityObjectToClipPos1_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g36 = (( ( computeScreenPos3_g33 / (computeScreenPos3_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g36 = packedInput.ase_texcoord6.xyz;
				float3 VertPos20_g36 = vertexToFrag27_g36;
				float Hash20_g36 = (EmissionHash5_g32).w;
				float ifLocalVar62_g32 = 0;
				UNITY_BRANCH 
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag27_g36 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag27_g36;
						...
						)
			{
				...
				float4 computeScreenPos3_g33 = ComputeScreenPos( unityObjectToClipPos1_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g36 = (( ( computeScreenPos3_g33 / (computeScreenPos3_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g36 = packedInput.ase_texcoord10.xyz;
				float3 VertPos20_g36 = vertexToFrag27_g36;
				float Hash20_g36 = (EmissionHash5_g32).w;
				float ifLocalVar62_g32 = 0;
				UNITY_BRANCH 
...
/*ASEBEGIN
Version=18935
396;313.6;1104;664.6;497.8782;294.5931;1.6;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;157;512,-736;Inherit;True;Property;_Tex2;Albedo 2;15;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;136;512,-1408;Inherit;False;Property;_UseTex1;Use Texture 1;12;1;[Toggle];Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;29;512,-1120;Inherit;True;Property;_MainTex;Albedo;10;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;155;512,-928;Inherit;True;Property;_Tex1;Albedo 1;13;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;143;512,-1312;Inherit;False;Property;_UseTex2;Use Texture 2;14;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;191;0,544;Inherit;False;Property;_RandomDither;Random Dither;9;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;193;0,448;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;11;0;Create;True;0;0;0;False;0;False;256;256;False;0;1;INT;0
Node;AmplifyShaderEditor.TexturePropertyNode;192;0,224;Inherit;True;Property;_DitherTexture;Dither Texture;8;0;Create;True;0;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;122;0,736;Inherit;False;Property;_Dithering;Dithering;7;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;119;576,96;Inherit;False;Mud Alpha Threshold;-1;;36;926535703f4c32948ac1f55275a22bf0;0;9;8;FLOAT2;0,0;False;15;FLOAT3;0,0,0;False;18;FLOAT;0;False;22;FLOAT;0;False;19;SAMPLER2D;0;False;26;INT;256;False;9;INT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;2;FLOAT;24;FLOAT;25
...
ASEEND*/
//CHKSM=02ACD5ED2EA64563EFA32A909CBE86ECDD064EE4