	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float localMudBunMeshPoint4_g1 = ( 0.0 );
				int VertexID4_g1 = inputMesh.ase_vertexID;
				float3 PositionWs4_g1 = float3( 0,0,0 );
				...
				float Metallic4_g1 = 0;
				float Smoothness4_g1 = 0;
				float4 TextureWeight4_g1 = float4( 1,0,0,0 );
				float SdfValue4_g1 = 0;
				float3 Outward2dNormalLs4_g1 = float3( 0,0,0 );
				float3 Outward2dNormalWs4_g1 = float3( 0,0,0 );
				{
				float4 positionWs;
				float2 metallicSmoothness;
				mudbun_mesh_vert(VertexID4_g1, positionWs, PositionLs4_g1, NormalWs4_g1, NormalLs4_g1, TangentWs4_g1, TangentLs4_g1, Color4_g1, EmissionHash4_g1, metallicSmoothness, TextureWeight4_g1, SdfValue4_g1, Outward2dNormalLs4_g1, Outward2dNormalWs4_g1);
				PositionWs4_g1 = positionWs.xyz;
				Metallic4_g1 = metallicSmoothness.x;
				Smoothness4_g1 = metallicSmoothness.y;
				#ifdef MUDBUN_BUILT_IN_RP
				#ifndef MUDBUN_VERTEX_SHADER
				v.tangent = float4(TangentWs4_g1, 0.0f);
				...
				float3 vertexToFrag16_g1 = PositionWs4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord6.yzw = vertexToFrag16_g1;
				float3 vertexToFrag27_g3 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag27_g3;
				...
				#endif
				float3 vertexValue = PositionWs4_g1;
						...
						)
			{
				...
				float4 unityObjectToClipPos1_g2 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g1));
				float4 computeScreenPos3_g2 = ComputeScreenPos( unityObjectToClipPos1_g2 , _ProjectionParams.x );
				float2 ScreenPos20_g3 = (( ( computeScreenPos3_g2 / (computeScreenPos3_g2).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g3 = packedInput.ase_texcoord7.xyz;
				float3 VertPos20_g3 = vertexToFrag27_g3;
				float localMudBunMeshPoint4_g1 = ( 0.0 );
				...
				float temp_output_7_0 = ( ( sin( ( ( _SpatialFrequency * 6.283185 * vertexToFrag15 ) + mulTime10 ) ) + 1.0 ) * ( 1.0 - saturate( ( abs( vertexToFrag15 ) / _FadeDistance ) ) ) * AlphaOut20_g3 );
				float temp_output_3_25 = AlphaThreshold20_g3;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag27_g3 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag27_g3;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 computeScreenPos3_g2 = ComputeScreenPos( unityObjectToClipPos1_g2 , _ProjectionParams.x );
				float2 ScreenPos20_g3 = (( ( computeScreenPos3_g2 / (computeScreenPos3_g2).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g3 = packedInput.ase_texcoord2.xyz;
				float3 VertPos20_g3 = vertexToFrag27_g3;
				float localMudBunMeshPoint4_g1 = ( 0.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g3 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag27_g3;
				float4 vertexToFrag5_g1 = Color4_g1;
					...
					)
			{
				...
				float4 computeScreenPos3_g2 = ComputeScreenPos( unityObjectToClipPos1_g2 , _ProjectionParams.x );
				float2 ScreenPos20_g3 = (( ( computeScreenPos3_g2 / (computeScreenPos3_g2).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g3 = packedInput.ase_texcoord5.xyz;
				float3 VertPos20_g3 = vertexToFrag27_g3;
				float localMudBunMeshPoint4_g1 = ( 0.0 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag27_g3 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag27_g3;
						...
						)
			{
				...
				float4 computeScreenPos3_g2 = ComputeScreenPos( unityObjectToClipPos1_g2 , _ProjectionParams.x );
				float2 ScreenPos20_g3 = (( ( computeScreenPos3_g2 / (computeScreenPos3_g2).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g3 = packedInput.ase_texcoord9.xyz;
				float3 VertPos20_g3 = vertexToFrag27_g3;
				float localMudBunMeshPoint4_g1 = ( 0.0 );
...
/*ASEBEGIN
Version=18935
396;313.6;1104;664.6;599.845;-38.25957;1.657553;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1;-1280,0;Inherit;False;Mud Mesh;0;;1;4f444db5091a94140ab2b15b933d37b6;0;0;17;COLOR;9;FLOAT;13;FLOAT3;10;FLOAT;11;FLOAT;12;FLOAT4;33;FLOAT3;0;FLOAT3;32;FLOAT3;2;FLOAT3;31;FLOAT3;53;FLOAT3;52;FLOAT3;48;FLOAT3;46;FLOAT;45;FLOAT2;15;FLOAT;41
...
ASEEND*/
//CHKSM=4B2243C04BE479EE26EC85A41AEE12DCBDB4B47D