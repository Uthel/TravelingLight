...
Shader "MudBun/Floater Splat (HDRP)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 CenterWs5_g33 = float3( 0,0,0 );
				float3 CenterLs5_g33 = float3( 0,0,0 );
				...
				float SdfValue5_g33 = 0.0;
				float3 Outward2dNormalLs5_g33 = float3( 0,0,0 );
				float3 Outward2dNormalWs5_g33 = float3( 0,0,0 );
				float3 localMudBunSplatPoint5_g33 = MudBunSplatPoint( VertexID5_g33 , PositionLs5_g33 , NormalWs5_g33 , NormalLs5_g33 , TangentWs5_g33 , TangentLs5_g33 , CenterWs5_g33 , CenterLs5_g33 , Color5_g33 , EmissionHash5_g33 , Metallic5_g33 , Smoothness5_g33 , Tex5_g33 , TextureWeight5_g33 , SdfValue5_g33 , Outward2dNormalLs5_g33 , Outward2dNormalWs5_g33 );
				float3 temp_output_190_21 = localMudBunSplatPoint5_g33;
				float3 temp_output_190_52 = TangentWs5_g33;
				float3 temp_output_190_60 = CenterWs5_g33;
				float3 Position6_g279 = temp_output_190_60;
				float Size6_g279 = 0.1;
				float3 localSimplexNoiseGradient6_g279 = SimplexNoiseGradient6_g279( Position6_g279 , Size6_g279 );
				float3 Position6_g280 = ( temp_output_190_60 + ( _TimeParameters.x * _Frequency ) + ( localSimplexNoiseGradient6_g279 * 1.0 ) );
				float Size6_g280 = 0.5;
				float3 localSimplexNoiseGradient6_g280 = SimplexNoiseGradient6_g280( Position6_g280 , Size6_g280 );
				float3 temp_output_212_0 = ( localSimplexNoiseGradient6_g280 * _OffsetAmount );
				float3 temp_output_190_28 = NormalWs5_g33;
				...
				float3 vertexToFrag27_g281 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag27_g281;
				...
				#endif
				float3 vertexValue = ( temp_output_190_21 + ( temp_output_190_52 * (temp_output_212_0).x ) + ( cross( temp_output_190_28 , temp_output_190_52 ) * (temp_output_212_0).z ) );
				...
				inputMesh.normalOS = temp_output_190_28;
						...
						)
			{
				...
				float4 temp_output_7_0_g33 = ( _Color * vertexToFrag3_g33 * _IsSplatRenderMaterial );
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g33 ) * temp_output_7_0_g33 );
				float localComputeOpaqueTransparency20_g281 = ( 0.0 );
				float3 vertexToFrag20_g33 = packedInput.ase_texcoord7.xyz;
				float4 unityObjectToClipPos1_g34 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g33));
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g281 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g281 = packedInput.ase_texcoord8.xyz;
				...
				float3 Outward2dNormalWs5_g33 = float3( 0,0,0 );
				float3 localMudBunSplatPoint5_g33 = MudBunSplatPoint( VertexID5_g33 , PositionLs5_g33 , NormalWs5_g33 , NormalLs5_g33 , TangentWs5_g33 , TangentLs5_g33 , CenterWs5_g33 , CenterLs5_g33 , Color5_g33 , EmissionHash5_g33 , Metallic5_g33 , Smoothness5_g33 , Tex5_g33 , TextureWeight5_g33 , SdfValue5_g33 , Outward2dNormalLs5_g33 , Outward2dNormalWs5_g33 );
				float Hash20_g281 = (EmissionHash5_g33).w;
				float ifLocalVar62_g33 = 0;
				UNITY_BRANCH 
				if( length( vertexToFrag34_g33 ) <= 0.5 )
				ifLocalVar62_g33 = 1.0;
				else
				ifLocalVar62_g33 = 0.0;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g33 = 1.0;
				#else
				float staticSwitch50_g33 = ifLocalVar62_g33;
				#endif
				float AlphaIn20_g281 = ( (temp_output_7_0_g33).a * staticSwitch50_g33 );
				...
				float temp_output_194_0 = ( (temp_output_124_0).a * AlphaOut20_g281 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag27_g281 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag27_g281;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g281 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g281 = packedInput.ase_texcoord3.xyz;
				float3 VertPos20_g281 = vertexToFrag27_g281;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g281 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag27_g281;
					...
					)
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g281 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g281 = packedInput.ase_texcoord4.xyz;
				float3 VertPos20_g281 = vertexToFrag27_g281;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g281 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag27_g281;
					...
					)
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g281 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g281 = packedInput.ase_texcoord6.xyz;
				float3 VertPos20_g281 = vertexToFrag27_g281;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag27_g281 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag27_g281;
						...
						)
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g281 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g281 = packedInput.ase_texcoord10.xyz;
				float3 VertPos20_g281 = vertexToFrag27_g281;
...
/*ASEBEGIN
Version=18935
396;313.6;1104;664.6;337.8366;778.0665;1.849612;True;False
Node;AmplifyShaderEditor.FunctionNode;190;0,-352;Inherit;False;Mud Splat;0;;33;1947d49d4d7bb92419410ba0439aa2bc;0;0;20;COLOR;22;FLOAT2;29;FLOAT;24;FLOAT3;27;FLOAT;26;FLOAT;23;FLOAT4;45;FLOAT3;21;FLOAT3;43;FLOAT3;28;FLOAT3;42;FLOAT3;52;FLOAT3;53;FLOAT3;60;FLOAT3;61;FLOAT3;68;FLOAT3;67;FLOAT;66;FLOAT2;25;FLOAT;57
Node;AmplifyShaderEditor.SimpleTimeNode;206;0,384;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;207;0,480;Inherit;False;Property;_Frequency;Frequency;6;0;Create;True;0;0;0;False;0;False;0.1;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;209;384,256;Inherit;False;Mud Noise Gradient;-1;;279;ded4656e0e0531448b1f2a26fd64d584;0;3;2;FLOAT3;0,0,0;False;5;FLOAT;0.1;False;7;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;208;448,384;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;29;256,-640;Inherit;True;Property;_MainTex;Albedo;8;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleAddOpNode;211;656,304;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;210;0,576;Inherit;False;Property;_OffsetAmount;Offset Amount;7;0;Create;True;0;0;0;False;0;False;0.01;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;193;-16,1008;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;13;0;Create;True;0;0;0;False;0;False;256;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;-16,1200;Inherit;False;Property;_AlphaCutoutThreshold;Alpha Cutout Threshold;10;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;191;-16,1104;Inherit;False;Property;_RandomDither;Random Dither;9;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;212;832,336;Inherit;False;Mud Noise Gradient;-1;;280;ded4656e0e0531448b1f2a26fd64d584;0;3;2;FLOAT3;0,0,0;False;5;FLOAT;0.5;False;7;FLOAT;0.1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;192;-16,784;Inherit;True;Property;_DitherTexture;Dither Texture;12;0;Create;True;0;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;122;-16,1296;Inherit;False;Property;_Dithering;Dithering;11;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CrossProductOpNode;213;928,560;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;119;720,656;Inherit;False;Mud Alpha Threshold;-1;;281;926535703f4c32948ac1f55275a22bf0;0;9;8;FLOAT2;0,0;False;15;FLOAT3;0,0,0;False;18;FLOAT;0;False;22;FLOAT;0;False;19;SAMPLER2D;0;False;26;INT;256;False;9;INT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;2;FLOAT;24;FLOAT;25
...
Node;AmplifyShaderEditor.ComponentMaskNode;214;1120,416;Inherit;False;False;False;True;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;215;1120,288;Inherit;False;True;False;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;217;1392,416;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;216;1392,288;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;194;1504,-352;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;218;1680,208;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;213;0;190;28
WireConnection;213;1;190;52
...
WireConnection;86;11;218;0
WireConnection;86;12;190;28
ASEEND*/
//CHKSM=1396B694BE6B463722D268D98053D911FF7B13E1