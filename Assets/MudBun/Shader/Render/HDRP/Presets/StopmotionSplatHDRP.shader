...
Shader "MudBun/Stopmotion Splat (HDRP)"
{
	Properties
	{
		...
		[ASEBegin]_NoiseSize("Noise Size", Float) = 0.5
		...
		[ASEEnd]_DitherTextureSize("Dither Texture Size", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 Position6_g260 = ( temp_output_190_21 + lerpResult10_g258 );
				float Size6_g260 = _NoiseSize;
				...
				float3 vertexToFrag27_g259 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag27_g259;
				...
				#endif
				float3 vertexValue = ( temp_output_190_21 + ( localSimplexNoiseGradient6_g260 * _OffsetAmount ) );
						...
						)
			{
				...
				float2 ScreenPos20_g259 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g259 = packedInput.ase_texcoord8.xyz;
				...
				float3 Outward2dNormalWs5_g33 = float3( 0,0,0 );
				float3 localMudBunSplatPoint5_g33 = MudBunSplatPoint( VertexID5_g33 , PositionLs5_g33 , NormalWs5_g33 , NormalLs5_g33 , TangentWs5_g33 , TangentLs5_g33 , CenterWs5_g33 , CenterLs5_g33 , Color5_g33 , EmissionHash5_g33 , Metallic5_g33 , Smoothness5_g33 , Tex5_g33 , TextureWeight5_g33 , SdfValue5_g33 , Outward2dNormalLs5_g33 , Outward2dNormalWs5_g33 );
				float Hash20_g259 = (EmissionHash5_g33).w;
				...
				#endif
				float AlphaIn20_g259 = ( (temp_output_7_0_g33).a * staticSwitch50_g33 );
				...
				float temp_output_194_0 = ( (temp_output_124_0).a * AlphaOut20_g259 );
				float temp_output_119_25 = AlphaThreshold20_g259;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag27_g259 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag27_g259;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g259 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g259 = packedInput.ase_texcoord3.xyz;
				float3 VertPos20_g259 = vertexToFrag27_g259;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g259 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag27_g259;
					...
					)
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g259 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g259 = packedInput.ase_texcoord4.xyz;
				float3 VertPos20_g259 = vertexToFrag27_g259;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag27_g259 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag27_g259;
					...
					)
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g259 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g259 = packedInput.ase_texcoord6.xyz;
				float3 VertPos20_g259 = vertexToFrag27_g259;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag27_g259 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag27_g259;
						...
						)
			{
				...
				float4 computeScreenPos3_g34 = ComputeScreenPos( unityObjectToClipPos1_g34 , _ProjectionParams.x );
				float2 ScreenPos20_g259 = (( ( computeScreenPos3_g34 / (computeScreenPos3_g34).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g259 = packedInput.ase_texcoord10.xyz;
				float3 VertPos20_g259 = vertexToFrag27_g259;
...
/*ASEBEGIN
Version=18935
396;313.6;1104;664.6;841.1503;65.50796;1.999855;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;196;0,416;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;195;0,512;Inherit;False;Property;_TimeInterval;Time Interval;8;0;Create;True;0;0;0;False;0;False;0.15;0.15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;197;256,448;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;29;256,-640;Inherit;True;Property;_MainTex;Albedo;9;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FloorOpNode;198;416,448;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;191;0,1088;Inherit;False;Property;_RandomDither;Random Dither;10;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;200;576,448;Inherit;False;Random Range;-1;;258;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;10000;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;0,1184;Inherit;False;Property;_AlphaCutoutThreshold;Alpha Cutout Threshold;11;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;122;0,1280;Inherit;False;Property;_Dithering;Dithering;12;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;192;0,768;Inherit;True;Property;_DitherTexture;Dither Texture;13;0;Create;True;0;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.IntNode;193;0,992;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;14;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;205;0,320;Inherit;False;Property;_OffsetAmount;Offset Amount;7;0;Create;True;0;0;0;False;0;False;0.005;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;201;1152,416;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;119;576,640;Inherit;False;Mud Alpha Threshold;-1;;259;926535703f4c32948ac1f55275a22bf0;0;9;8;FLOAT2;0,0;False;15;FLOAT3;0,0,0;False;18;FLOAT;0;False;22;FLOAT;0;False;19;SAMPLER2D;0;False;26;INT;256;False;9;INT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;2;FLOAT;24;FLOAT;25
Node;AmplifyShaderEditor.RangedFloatNode;204;0,224;Inherit;False;Property;_NoiseSize;Noise Size;6;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;202;1344,368;Inherit;False;Mud Noise Gradient;-1;;260;ded4656e0e0531448b1f2a26fd64d584;0;3;2;FLOAT3;0,0,0;False;5;FLOAT;0.1;False;7;FLOAT;0.1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;203;1664,336;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;202;5;204;0
WireConnection;202;7;205;0
WireConnection;203;0;190;21
...
WireConnection;86;11;203;0
WireConnection;86;12;190;28
ASEEND*/
//CHKSM=B922C940317C271FB1920ADFE988CFC79E015BD0