...
Shader "MudBun/Mud Decal Mesh (HDRP)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 InvertDepthDirHD5_g287( float3 In )
			{
				float3 result = In;
				#if !defined(ASE_SRP_VERSION) || ASE_SRP_VERSION <= 70301 || ASE_SRP_VERSION >= 80301 
				result *= float3(1,1,-1);
				#endif
				return result;
			}
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexToFrag107_g286 = inputMesh.positionOS;
				o.ase_texcoord1.xyz = vertexToFrag107_g286;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 vertexToFrag107_g286 = packedInput.ase_texcoord1.xyz;
				float4 unityObjectToClipPos20_g287 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag107_g286));
				float4 computeScreenPos23_g287 = ComputeScreenPos( unityObjectToClipPos20_g287 , _ProjectionParams.x );
				...
				float2 UV22_g288 = computeScreenPos23_g287.xy;
				float2 localUnStereo22_g288 = UnStereo( UV22_g288 );
				float2 break9_g287 = localUnStereo22_g288;
				float clampDepth12_g287 = SampleCameraDepth( computeScreenPos23_g287.xy );
				...
				float3 In5_g287 = temp_output_10_0_g287;
				float3 localInvertDepthDirHD5_g287 = InvertDepthDirHD5_g287( In5_g287 );
				float4 appendResult2_g287 = (float4(localInvertDepthDirHD5_g287 , 1.0));
				...
				float4 lerpResult21 = lerp( _EdgeFadeColor , ( ( ( ( _StencilMask + _ColorBlendSrc + _ColorBlendDst ) * 0 ) + 1 ) * temp_output_25_0_g286 ) , saturate( ( -SdfValue49_g286 / max( _EdgeFadeDistance , 0.0 ) ) ));
				
				surfaceDescription.Color = lerpResult21.rgb;
				surfaceDescription.Emission = ( Emission49_g286 * (_Emission).rgb );
				surfaceDescription.Alpha = (lerpResult21).a;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexToFrag107_g286 = inputMesh.positionOS;
				o.ase_texcoord.xyz = vertexToFrag107_g286;
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 vertexToFrag107_g286 = packedInput.ase_texcoord.xyz;
				float4 unityObjectToClipPos20_g287 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag107_g286));
				float4 computeScreenPos23_g287 = ComputeScreenPos( unityObjectToClipPos20_g287 , _ProjectionParams.x );
				computeScreenPos23_g287 = computeScreenPos23_g287 / computeScreenPos23_g287.w;
				computeScreenPos23_g287.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? computeScreenPos23_g287.z : computeScreenPos23_g287.z* 0.5 + 0.5;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 vertexToFrag107_g286 = packedInput.ase_texcoord3.xyz;
				float4 unityObjectToClipPos20_g287 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag107_g286));
				float4 computeScreenPos23_g287 = ComputeScreenPos( unityObjectToClipPos20_g287 , _ProjectionParams.x );
				computeScreenPos23_g287 = computeScreenPos23_g287 / computeScreenPos23_g287.w;
				computeScreenPos23_g287.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? computeScreenPos23_g287.z : computeScreenPos23_g287.z* 0.5 + 0.5;
...
/*ASEBEGIN
Version=18935
396;313.6;1104;664.6;2174.19;626.0552;1.899513;True;False
Node;AmplifyShaderEditor.IntNode;7;-1664,-544;Inherit;False;Property;_StencilMask;Stencil Mask;4;0;Create;True;0;0;0;False;0;False;32;32;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;8;-1664,-352;Inherit;False;Property;_ColorBlendDst;Color Blend Dst;3;0;Create;True;0;0;0;False;0;False;10;10;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;9;-1664,-448;Inherit;False;Property;_ColorBlendSrc;Color Blend Src;2;0;Create;True;0;0;0;False;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1664,224;Inherit;False;Property;_EdgeFadeDistance;Edge Fade Distance;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-1408,-416;Inherit;False;3;3;0;INT;0;False;1;INT;0;False;2;INT;0;False;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;10;-1664,-256;Inherit;False;Mud Decal;5;;286;680e80eee6c3d494fb7f6eab0eef7416;0;0;6;COLOR;9;FLOAT;13;FLOAT3;10;FLOAT;11;FLOAT;12;FLOAT;45
Node;AmplifyShaderEditor.SimpleMaxOpNode;14;-1408,224;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;15;-1344,48;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-1280,-416;Inherit;False;2;2;0;INT;0;False;1;INT;0;False;1;INT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;16;-1152,128;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-1136,-416;Inherit;False;2;2;0;INT;0;False;1;INT;1;False;1;INT;0
Node;AmplifyShaderEditor.SaturateNode;18;-992,128;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;19;-896,257.8995;Inherit;False;Property;_EdgeFadeColor;Edge Fade Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-896,-352;Inherit;False;2;2;0;INT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;21;-640,0;Inherit;False;3;0;COLOR;1,1,1,0;False;1;COLOR;1,1,1,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ComponentMaskNode;22;-384,112;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-128,0;Float;False;True;-1;2;MudBun.DecalMeshMaterialEditor;0;13;MudBun/Mud Decal Mesh (HDRP);7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;9;0;True;8;0;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;7;255;True;7;255;True;7;6;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-24;True;7;False;-32;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;0;0;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;0;0;0;7;True;False;True;True;True;True;False;False;;False;0
...
WireConnection;20;1;10;9
WireConnection;21;0;19;0
WireConnection;21;1;20;0
WireConnection;21;2;18;0
WireConnection;22;0;21;0
WireConnection;0;0;21;0
WireConnection;0;1;10;10
WireConnection;0;2;22;0
ASEEND*/
//CHKSM=DA20D5A17947616F2C8C7BA90655273B35D95309